  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#fff] px-4 sm:px-0">
      <div className="card w-full max-w-xl mt-8">
        ...
        <p className="text-lg text-black/80 font-sans mb-4">Your privacy is important to us. This policy explains how Vivaad collects, uses, and protects your personal information.</p>
